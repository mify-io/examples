// vim: set ft=go:// THIS FILE IS AUTOGENERATED, DO NOT EDIT
// Generated by mify
// vim: set ft=go:
...
import (
	...
	"example.com/namespace/oauth-example/go-services/internal/books-service-origin/app/router"
	"example.com/namespace/oauth-example/go-services/internal/books-service-origin/generated/api/init"
...
func NewMifyServiceApp(goGontext context.Context) *MifyServiceApp {
	serviceContext, err := core.NewMifyServiceContext(
		goGontext, "books-service-origin",
