...
func NewRouter(mifyCtx *core.MifyServiceContext, routerConfig RouterConfig, reqExtraFactory core.RequestExtraFactory, routers ...Router) chi.Router {
	router := chi.NewRouter()
	router.Use(middleware.RequestID)
	router.Use(requestContextInitBuilder(mifyCtx))
	router.Use(Recoverer())
	router.Use(Metrics())
	router.Use(CORS())
	router.Use(requestContextBuild(reqExtraFactory))
